package com.project.genericspringapp.controller;
...
import com.project.genericspringapp.service.DepartmentService;
...
class DepartmentControllerTest {
    ...
    @BeforeEach
    void setUp() {
        department = Department.builder().departmentAddress("London").departmentCode("ID-06").departmentName("HR").departmentId(1L).build();
    }

    @Test
    void saveDepartment() throws Exception {
         Department inputDepartment = Department.builder().departmentAddress("London").departmentCode("ID-06").departmentName("HR").build();
